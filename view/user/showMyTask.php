...
<head>
    ...
    <link rel="stylesheet" href="..\..\controller\user\mytask\mytask.css">
...
<div class="container">
        <main class="table" >
            ...
            <section class="table__body"id="customers_table">
                <table>
                    ...
                    <tbody>
                        <?php
                            require_once("..\..\controller\user\mytask\mytask.php");
                            getMyTask($act);
                        ?>
                    </tbody>
                </table>
        ...
        pagination($act,"SELECT CEILING(COUNT(`idcolis`)/10) as nb  FROM `colis` WHERE `id_client`='L1';");
        ?>
    </div>
