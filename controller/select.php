...
<td> <?php echo  $row['client_nom']." ".$row['client_prenom']?></td>
        ...
        <form action="..\view\showbids.php" method="POST"><input type="text" id="bid" name="bid_id" value="<?php echo $row['idcolis']?>" style="display:none;"/><button class="bids-button" onclick="bidsAction()">bids</button></form>
