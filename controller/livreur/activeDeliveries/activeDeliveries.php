...
<body>
    ...
    function showActiveDeliveries(){ 
        ...
        try{
            $query = $pdo->prepare(
                'SELECT u.nom, u.prenom, a.depart, a.arrivee, a.idcolis, a.size, a.poids,a.budget, MIN(b.montant) AS montant_minimum FROM DATA u JOIN colis a ON u.ID = a.id_client LEFT JOIN colis_a_encherer b ON a.idcolis = b.idcolis GROUP BY u.nom, u.prenom, a.depart, a.arrivee, a.size, a.poids,a.budget;'
            );
    ...
    <div class="cardActDel" style="animation-duration:<?php echo $countannim;$countannim = $countannim +0.15;?>s;">
        ...
        <div class="cardInfo">
            <div class="useInfo">
                ...
                <img src="../../view/livreur/assets/userlogo.png" alt="user">
            ...
            <div class="bidInfo">
                ...
                <img src="../../view/livreur/assets/bidLogo.png" alt="bid">
                <p>Current Bid</p>
                <p><?php
    ...
    <div class="bidForm hide">
        <div>
            ...
            <form action="..\..\controller\livreur\activeDeliveries\addBid.php" method="POST" onsubmit="return control(<?php echo ($countbox-1);?>)">        
