...
?>
    <tr>
        ...
        <td class="tdUser"><img src="../../view/livreur/assets/user.png" alt="user"><p><?php echo $row["prenomClient"] . " " . $row["nomClient"] ?></p></td>
        ...
        <td>
            ...
            <form action="../../controller/livreur/manageOrders/deleteOrder.php" method="POST" onsubmit="return confirmdelete()">
    ...
    <div class="bidForm hide">
        <div>
            ...
            <form action="../../controller/livreur/manageOrders/updateOrder.php" method="POST" onsubmit="return control(<?php echo ($countbox-1);?>)">        
